...
PARAM_LABELS = {
    ...
    'DYU': 'Y Units',
    'EXP': 'Experiment',
    'FFP': 'Frequency First Point',
    'FLP': 'Frequency Last Point',
    'FOC': 'Focal Length',
    'FXV': 'First X Value',
    'GBW': 'Number of Good Backward Scans',
    'GFW': 'Number of Good Forward Scans',
    'HFF': 'High Folding Limit after Filtering',
    ...
    'LCT': 'Location',
    'LFF': 'Low Folding Limit after Filtering',
...
STRUCT_3D_INFO_BLOCK = [
    ...
    {'key': 'ffp', 'fmt': 'd', 'dtype': np.float64},
    {'key': 'flp', 'fmt': 'd', 'dtype': np.float64},
