...
def test_opus_file_detection(test_directory):
    ...
    assert len(all_files) == 2, "No files found in test directory"
    assert len(opus_files) == 1, "No OPUS files found in test directory"
